...
pub fn program_entry() -> i8 {
    // Benchmark for DIVW instruction (32-bit division)
    // Using pre-generated values that fit in 32-bit range

    // Array of 32-bit dividends
    ...
    let mut result: i32 = 0;  // DIVW produces signed 32-bit result
    let mut accumulator: i32 = 0;

    for i in 0..iterations {
        let dividend_idx = (i as usize) & 0x3F;  // % 64
        let divisor_idx = ((i >> 6) as usize) & 0x1F;  // % 32
